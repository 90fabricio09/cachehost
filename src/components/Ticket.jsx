...
import ImgSup from '../assets/icon.png'
            ...
            <div className="grid-overlay"></div>
                ...
                <div id="aba" className="aba" style={{ opacity: 0, transition: 'opacity 300ms ease' }}>
                    ...
                    <div className="global-content">
                        ...
                        <div className="content-sup">
                            <a href="https://discord.gg/CC7HH2mzsK" target="_blank">
                                <h3>Nosso Discord</h3>
                        ...
                        <div className="content-sup">
                            <a href="/chat">
                                <h3>Fale com CacheBot</h3>
                                <p>Fale com o nosso chatbot para duvidas simples.</p>
                                {/* <img className="sup-icon" src={ImageSup} alt="Logo CacheHost" /> */}
